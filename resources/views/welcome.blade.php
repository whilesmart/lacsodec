            ...
            <div class="con">
                ...
                <div class="buttons">
                    <a href="{{ route('register-cso') }}"
                        class="custom-button secondary"><span>{{ __('welcome.Register a CSO') }}</span></a>
                    <a href="{{ route('register') }}"
                        class="custom-button white-border"><span>{{ __('welcome.join us') }}</span></a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @if (!$loop->first)
                                <div class="feed">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{{ route('blog-details', ['blog' => $article->slug]) }}"
